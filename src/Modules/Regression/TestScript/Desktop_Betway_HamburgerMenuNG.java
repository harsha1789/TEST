...
*
*/
public class Desktop_Betway_HamburgerMenuNG {
 
	public ScriptParameters scriptParameters;
	Logger log = Logger.getLogger(Desktop_Betway_HamburgerMenuNG.class.getName()); // To get Logs
...
//    	ArrayList<String> tabs = new ArrayList<String>(webdriver.getWindowHandles());
    	...
    	try {
			...
			cfnlib.HM_Cut1BoostPage(report);
			cfnlib.HM_BetwayInsiderBlogPage(report);
			cfnlib.HM_BetwayAppPageNG(report);
			cfnlib.HM_BettingRulesPageNG(report);	
			cfnlib.HM_CashOutPage(report);
			cfnlib.HM_StatsCenterPageNG(report);
			cfnlib.HM_PrintFixturePage(report);
